...
export const CTA = () => {
  return (
    <section className="py-16 md:py-20 bg-gradient-to-r from-[#FAF3E1] to-[#A9A298]">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center px-4">
            ...
            <Button 
              size="lg" 
              variant="outline"
              className="border-[#223C30] text-[#223C30] hover:bg-[#223C30] hover:text-white hover:scale-105 transition-all duration-300 px-6 md:px-8 py-4 md:py-6 rounded-full group w-full sm:w-auto"
            >
